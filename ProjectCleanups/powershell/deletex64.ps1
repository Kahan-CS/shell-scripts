# This script deletes all 'x64' folders in the specified target folder. It is a simple script without any functions or progress tracking. It prompts for confirmation before proceeding with the deletion.
